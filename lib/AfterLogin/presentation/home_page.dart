      ...
      child: Scaffold(
        body: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text("Monthly Total Balance", style: TextStyle(fontSize: 16, color: Colors.grey.withOpacity(0.97)),),
        ...
        bottomNavigationBar: BottomAppBar(
          child: Row(
            ...
            children: <Widget>[
              SizedBox(child: IconButton(onPressed: (){}, icon: Icon(Icons.home)), width: 120,),
              SizedBox(child: IconButton(onPressed: (){}, icon: Icon(Icons.analytics)), width: 120,),
              SizedBox(child: IconButton(onPressed: (){}, icon: Icon(Icons.settings)), width: 120),
            ],
          )
        ),
      ),
